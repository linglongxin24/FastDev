package com.kejiang.yuandl.net;
...
public class RetrofitClient {
   ...
   /**
    ...
    public Subscription getData(Subscriber<Object> subscriber, String ip) {
    ...
    public Subscription get(String url, Map parameters, Subscriber<Object> subscriber) {
